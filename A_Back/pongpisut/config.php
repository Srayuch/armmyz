...
$config['mssql_host'] = "103.233.195.136,1433";
$config['mssql_user'] = "sa";
$config['mssql_password'] = "aWsFA64s1s45e2s1234s132s2e";
$config['db_name'] = "KN_Data";
...
$config['login_md5'] = false; //การล็อกอินหรือสมัครบัญชีผู้ใช้ dbo.Acoounts colum MD5Password ถ้าไม่มีการเข้ารหัส md5 ปรับเป็น false
$config['login_md5_salt'] = 'g5sc4gs1fz0h';

//AUTO Site to ssl
$config['auto_ssl'] = false; //บังคับผู้ใช้ SSL
$config['auto_ssl_url'] = "https://knz-th.tk/web/"; //domain ที่มีใบรองรับ SSL Cerficate
...
$config['fb']['regis'] = true;
$config['fb_app_id'] = '586964165054161';
$config['registerfb_accounstatus'] = 100;
$config['registerfb_AccountType'] = 2;
$config['registerfb_friends'] = 5; //จำนวนเพื่อนในเฟสบุค เท่านี้ถึงสมัครได้
