...
$_CONFIG['SERVER']['IP'] = '127.0.0.1,1503';														//IP SERVER
$_CONFIG['SERVER']['USER'] = 'sa';															//SQL USER
$_CONFIG['SERVER']['PASS'] = 'Muonline_server';												//SQL PASS
$_CONFIG['SERVER']['DB'] = 'WarZ';															//DB NAME
$_CONFIG['SERVER']['DEV'] = 'admin@server.com';												//ADMIN ID - ไอดีแอดมินสำหรับตั้งค่าในเว็บ
$_CONFIG['SERVER']['MD5'] = 0;
$_CONFIG['SERVER']['MD5KEY'] = 'g53vvc4fgd1fzh';															//MD5 - ถ้าไม่ใช้ Md5 ใส่ '0' 	ถ้าใช้ Md5 ใส่ '1'
$_CONFIG['SERVER']['NAME'] = 'K-NightZ';														//Server Name ชื่อเซิฟเวอร์ของคุณ
